package no.fremtind.intervju.integrasjonslag.service;

import no.fremtind.intervju.integrasjonslag.client.brevtjeneste.BrevtjenesteRestClient;
import no.fremtind.intervju.integrasjonslag.client.brevtjeneste.model.BrevStatus;
import no.fremtind.intervju.integrasjonslag.client.brevtjeneste.model.SendAvtalebrevRequest;
import no.fremtind.intervju.integrasjonslag.client.fagsystem.FagsystemRestClient;
...
import static no.fremtind.intervju.integrasjonslag.client.fagsystem.model.AvtaleType.FORSIKRING;
import static no.fremtind.intervju.integrasjonslag.controller.model.AvtaleStatus.SENDT;
